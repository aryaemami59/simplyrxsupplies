...
export type OldSuppliesSample = PartialObjectProperties<OldSupplies>;

export type NewSuppliesSample = PartialObjectProperties<Supplies>;

export const oldSuppliesSample = {
  items: [
    {
      id: 0,
      name: "10 Dram Vials",
...
export const newSuppliesSample = {
  ...
  categories: Object.values(oldSuppliesSample.categories),
  vendors: Object.values(oldSuppliesSample.vendors),
