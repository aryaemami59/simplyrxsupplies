 ...
 * it will return {@linkcode EMPTY_ARRAY} in order to prevent unnecessary reassignment of state values and maintain referential integrity as much as possible.
