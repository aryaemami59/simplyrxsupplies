...
export const selectByVendor = (vendorName) => (state) =>
  state.added[vendorName];
export const selectVendorsArr = (state) =>
...
export const selectNavsArr = (state) =>
  state.added.navsArr ? state.added.navsArr : empty;
export const addedItemsLength = (vendorName) => (state) =>
...
export const selectVendorOfficialName = (vendorName) => (state) =>
  state.added.vendorsObj ? state.added.vendorsObj[vendorName].officialName : "";
