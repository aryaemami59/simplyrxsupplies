...
function SwitchComponent({ clickHandler, checked, itemObj, vendorName, disabled, }) {
...
export default connect(mapStateToProps, mapDispatchToProps)(memo(SwitchComponent));
