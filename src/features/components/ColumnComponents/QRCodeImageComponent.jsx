      ...
      <Row>
        <Col md={12} className="position-relative">
          <Row className="justify-content-center">
            ...
            <QRCodeModal src={src} vendorName={vendorName} itemNumbers={itemNumbers}/>
          </Row>
          <Row className="justify-content-center">
            <img src={src} className="my-4 w-auto p-0" alt={`${vendorName}-QRCode`} key={`${vendorName}-QRCode-image-QRCodeImageComponent`} title={itemNumbers}/>
          </Row>
        </Col>
      </Row>
    </Container>);
