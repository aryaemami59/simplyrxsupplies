...
function QRCodeImageComponent({ vendorName }) {
    ...
    return (<div key={`${vendorName}-container-QRCodeImageComponent`}>
      ...
      <FontAwesomeIcon icon={faMagnifyingGlassPlus} size="xl" className="btn position-absolute m-3 top-0" inverse={darkTheme ? true : false} role="button" pull="left" onClick={showModal}/>
