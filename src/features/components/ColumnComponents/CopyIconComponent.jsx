...
const CopyIconComponent = ({ content, text, placement, vendorName, itemObj, }) => {
    ...
    const clickOnIcon = useCallback(() => dispatch({ type: ACTIONS.CLICK_ON_ICON }), []);
    const handleMouseEnter = useCallback(() => dispatch({ type: ACTIONS.HOVER_OVER_ICON }), []);
    const handleMouseLeave = useCallback(() => dispatch({ type: ACTIONS.HOVER_LEAVE }), []);
