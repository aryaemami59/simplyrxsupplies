...
const NavbarComponent = () => {
    ...
    return (<Navbar bg={darkTheme ? "dark" : "light"} expand="lg" sticky="top" variant={darkTheme ? "dark" : "light"} className="d-flex justify-content-start shadow" key={`Navbar-NavbarComponent`}>
