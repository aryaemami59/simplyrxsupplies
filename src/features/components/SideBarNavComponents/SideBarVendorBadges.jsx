...
const SideBarVendorBadges = ({ vendorName, itemObj, clickHandler, checked, disabled, officialVendorName, }) => {
...
const mapStateToProps = (state, ownProps) => {
    return {
        ...
        officialVendorName: state.added.vendorsObj[ownProps.vendorName].officialName,
    };
};
...
//   }),
// };
export default connect(mapStateToProps, mapDispatchToProps)(memo(SideBarVendorBadges));
